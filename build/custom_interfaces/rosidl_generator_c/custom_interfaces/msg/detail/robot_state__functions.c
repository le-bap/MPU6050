...
custom_interfaces__msg__RobotState__are_equal(const custom_interfaces__msg__RobotState * lhs, const custom_interfaces__msg__RobotState * rhs)
{
  ...
  // fallen_forward
  if (lhs->fallen_forward != rhs->fallen_forward) {
    return false;
  }
  // fallen_backwards
  if (lhs->fallen_backwards != rhs->fallen_backwards) {
    return false;
  }
  // fallen_side
  if (lhs->fallen_side != rhs->fallen_side) {
    return false;
  }
  return true;
}
  ...
  custom_interfaces__msg__RobotState * output)
{
  ...
  // fallen_forward
  output->fallen_forward = input->fallen_forward;
  // fallen_backwards
  output->fallen_backwards = input->fallen_backwards;
  // fallen_side
  output->fallen_side = input->fallen_side;
  return true;
}
