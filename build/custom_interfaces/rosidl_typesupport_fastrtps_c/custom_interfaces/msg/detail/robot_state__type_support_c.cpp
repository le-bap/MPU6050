  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fallen_forward
  {
    cdr << (ros_message->fallen_forward ? true : false);
  }

  // Field name: fallen_backwards
  {
    cdr << (ros_message->fallen_backwards ? true : false);
  }

  // Field name: fallen_side
  {
    cdr << (ros_message->fallen_side ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: fallen_forward
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->fallen_forward = tmp ? true : false;
  }
  ...
  // Field name: fallen_backwards
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->fallen_backwards = tmp ? true : false;
  }
  ...
  // Field name: fallen_side
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->fallen_side = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name fallen_forward
  {
    size_t item_size = sizeof(ros_message->fallen_forward);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name fallen_backwards
  {
    size_t item_size = sizeof(ros_message->fallen_backwards);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name fallen_side
  {
    size_t item_size = sizeof(ros_message->fallen_side);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
